...
namespace EFAutomation
{
    public class AutoContextFactory : IAutoContextFactory
    {
        ...
        private DbMigrationsConfiguration _dbMigrationsConfiguration;
        ...
        public IContext Context()
        {
            ...
            if(Configuration.AutoMigrateGeneratedMigrationsEnabled)
                MigrateToLatest();
        ...
        public void GenerateMigrations()
        {
            ...
            var migrationScaffolder = new MigrationScaffolder(_dbMigrationsConfiguration) { Namespace = "EFMigrations" };
        ...
        private void TryMigrate()
        {
            ...
            // Migrate
            var migrator = new DbMigrator(_dbMigrationsConfiguration);
            migrator.Update();
        }
