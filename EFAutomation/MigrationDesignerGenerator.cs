...
private string _MigrationIdField;

/// <summary>
/// Access the MigrationId parameter of the template.
/// </summary>
...
bool MigrationIdValueAcquired = false;
if (this.Session.ContainsKey("MigrationId"))
{
    this._MigrationIdField = ((string)(this.Session["MigrationId"]));
    MigrationIdValueAcquired = true;
}
if ((MigrationIdValueAcquired == false))
{
    object data = global::System.Runtime.Remoting.Messaging.CallContext.LogicalGetData("MigrationId");
    if ((data != null))
    {
...
if ((ClassNameValueAcquired == false))
{
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "12.0.0.0")]
    public class MigrationDesignerGeneratorBase
    {
        #region Fields
