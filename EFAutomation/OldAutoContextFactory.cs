...
namespace EFAutomation
{
    ...
    /// 
    /// </summary>
    public class OldAutoContextFactory : IAutoContextFactory
    {
        ...
        public OldAutoContextFactory(IAutoContextFactoryConfiguration configuration) : this()
        {
